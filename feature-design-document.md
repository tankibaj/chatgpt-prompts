...
I am a DevOps engineer who practices feature-driven development. Before working on a feature, I aim to write a Feature Design Document (FDD) that is detailed enough to serve as a comprehensive guide for development.

Please write a feature design document on this topic: upgrade the Argo CD version to the latest stable release, which is 2.6.7. [https://github.com/argoproj/argo-cd/releases/tag/v2.6.7](https://github.com/argoproj/argo-cd/releases/tag/v2.6.7)
